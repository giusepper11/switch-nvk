...
| Render → sampled image → compute → storage image chain | BLOCKED | initial/shared-layout failures plus `docs/testing/FG2_ROOT_STATE_DIAGNOSTIC_RUN_2026-08-20.md`, `docs/testing/FG2_ROOT_UPLOAD_CACHE_FLUSH_RUN_2026-08-21.md`, and `docs/testing/FG2_QMD_UPLOAD_IDENTITY_RUN_2026-08-21.md`; current root bytes reach a byte-identical mapped QMD at reused VA and direct `PCAS`, while the stale signature persists | test QMD-address reuse as the immediate discriminating GPU-consumption boundary; do not infer generic QMD or cache behavior |
